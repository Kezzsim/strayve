...
- The URL to an Shoutcast / Icecast server **must** be included as an argument when you start the server eg. `strayve.io http://momori.animenfo.com:8000`

That being said, if you’re feeling lucky; clone our code to your machine, navigate to the folder and hit `npm install` !
